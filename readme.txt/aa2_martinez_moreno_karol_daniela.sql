...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-09-2025 a las 17:22:00
...
(1, 'Laptop Intel Core i9', 1, 'Laptop', 1, 3500000.00, NULL, NULL, '2025-03-01', 'Versión mejorada con más rendimiento', 'Laptop de alto rendimiento para profesionales', '16GB RAM, SSD 512GB, Procesador Intel i7, Tarjeta gráfica NVIDIA GTX 1650', 'imagenes/Laptop_Intel_Core_i7.png'),
(2, 'Smartphone Galaxy S25', 2, 'Smartphone', 1, 2800000.00, NULL, NULL, '2025-08-15', 'Rendimiento fluido y cámara profesional para todo tipo de uso.', 'Teléfono inteligente con cámara profesional y alto rendimiento.', '12GB RAM, 256GB Almacenamiento, Procesador Exynos, Pantalla AMOLED 6.7 pulgadas', 'imagenes/Smartphone Galaxy S25.png'),
(3, 'iPhone 15 Pro', 3, 'Smartphone', 1, 5000000.00, NULL, NULL, '2025-09-01', 'Elegante y potente, ideal para fotos y gaming.', 'Último smartphone de Apple con cámara avanzada y pantalla Super Retina.', '6GB RAM, 256GB Almacenamiento, Procesador A17 Bionic', 'imagenes/iPhone 15 Pro.jpg'),
(4, 'Xiaomi 14', 4, 'Smartphone', 1, 1800000.00, NULL, NULL, '2024-12-20', 'Rendimiento confiable a buen precio.', 'Smartphone económico con buena cámara y batería duradera.', '8GB RAM, 128GB Almacenamiento, Procesador Snapdragon 8', 'imagenes/Xiaomi 14.webp'),
(5, 'Oppo Reno 12 F 5G', 5, 'Smartphone', 1, 1500000.00, NULL, NULL, '2024-11-10', 'Cámara profesional y diseño moderno.', 'Smartphone con cámara de 108MP y pantalla AMOLED.', '8GB RAM, 128GB Almacenamiento, Procesador MediaTek Dimensity', 'imagenes/Oppo_Reno_12.png'),
(6, 'Parlante Inalámbrico VTA 25W Sphere Beat', 6, 'Altavoz Inteligente', 3, 500000.00, NULL, NULL, '2023-05-05', 'Controla tu hogar y reproduce música con calidad.', 'Altavoz inteligente con asistente de voz integrado.', 'Wi-Fi, Bluetooth, Asistente de voz integrado', 'imagenes/VTA_Smart_Speaker.png'),
(7, 'Estación Inteligente', 7, 'Domótica', 1, 350000.00, NULL, NULL, '2024-01-20', 'Controla luces, cámaras y electrodomésticos desde tu smartphone.', 'Centro de control para dispositivos inteligentes del hogar.', 'Wi-Fi, Bluetooth, App móvil', 'imagenes/LifeSmart_Home_Hub.png'),
(8, 'Altavoz inteligente Alexa Echo Dot 5ta generación', 8, 'Altavoz Inteligente', 3, 400000.00, NULL, NULL, '2023-07-10', 'Controla tu hogar y escucha música fácilmente.', 'Altavoz inteligente con Alexa integrada.', 'Wi-Fi, Bluetooth, Alexa', 'imagenes/Amazon_Echo_Dot.webp'),
(9, 'Cámara IP Wi-Fi Imou Cruiser SE+', 9, 'Cámara de seguridad', 1, 350000.00, NULL, NULL, '2023-02-15', 'Fácil de instalar y controlar desde tu smartphone.', 'Cámara de seguridad para interior y exterior con visión nocturna.', 'Wi-Fi, Visión nocturna, App móvil', 'imagenes/IMOU_Camara_IP.webp'),
(10, 'Televisor HISENSE 50 pulgadas LED UHD 4K 50A6N', 10, 'Televisor', 4, 1800000.00, NULL, NULL, '2024-06-05', 'Imagen nítida y conexión a servicios de streaming.', 'Televisor inteligente con resolución 4K.', '4K, Smart TV, Wi-Fi, HDMI', 'imagenes/Hisense_Smart_TV_50.webp'),
(11, 'Nevera No Frost Brutos Grafito', 11, 'Electrodomésticos', 2, 2800000.00, NULL, NULL, '2023-10-10', 'Diseño moderno y excelente conservación de alimentos.', 'Refrigerador de alta capacidad con eficiencia energética.', '400L, Clase A+, Hielo automático', 'imagenes/Mabe_Refrigerador.webp'),
(12, 'Estufa con Horno Haceb 4 Puestos', 12, 'Electrodomésticos', 2, 1100000.00, NULL, NULL, '2023-08-15', 'Cocina de forma eficiente y segura.', 'Estufa moderna con horno y 4 quemadores.', 'Gas natural, Horno incorporado, 4 quemadores', 'imagenes/Haceb_Estufa.png'),
(14, 'Tablet Lenovo M10', 2, 'Tablet', 1, 950000.00, NULL, NULL, '2024-09-01', 'Tablet de gama media con buena relación calidad-precio', NULL, NULL, NULL);
...
(25, 8, 'secundaria', 'imagenes/Amazon_Echo_Dot_1.webp'),
...
(4, 2, 'pendiente', 450000.00, '2025-09-11');
...
(1, 'Administrador', 'admin@tienda.com', '2025-09-10', 'activo', '1234', 'Administrador'),
(2, 'Juan Pérez', 'cliente@correo.com', '2025-09-10', 'activo', '5678', 'Cliente');
...
--
ALTER TABLE `dispositivo`
  MODIFY `id_dispositivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
